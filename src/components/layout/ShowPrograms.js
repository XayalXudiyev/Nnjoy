...
const AutoPlayCarousel = () => {
    ...
    return (
        <div className='p-4'>
            <div className="d-flex align-items-center justify-content-between "><h1>Şou proqramlar</h1>
                <Button className='btn btn-dark h-25  ' onClick={handleButtonClicked}>Hamısına bax</Button>
            </div>
